...
ALTER TABLE ONLY public.edge_import_railways DROP CONSTRAINT "PKEY: edge_import_railways::import_id";
ALTER TABLE public.edge_import_railways ALTER COLUMN import_id DROP DEFAULT;
DROP SEQUENCE public.edge_import_railways_import_id_seq;
DROP TABLE public.edge_import_railways;
SET search_path = public, pg_catalog;
