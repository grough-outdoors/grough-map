...
ALTER TABLE ONLY public.edge_access DROP CONSTRAINT "PKEY: edge_access::access_id";
ALTER TABLE public.edge_access ALTER COLUMN access_id DROP DEFAULT;
DROP SEQUENCE public.edge_access_access_id_seq;
DROP TABLE public.edge_access;
SET search_path = public, pg_catalog;
