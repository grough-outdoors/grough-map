...
@route_marker_default_opacity:				0.5;
...
@route_label_default_colour:				#404040;
...
@route_label_default_distance:				1000;
...
@route_label_rcn_colour:					#5050e0;
@route_label_trail_colour:					@edge_access_decorator_legalpath_colour;
...
.route-label {
	...
	[class_name='Regional cycle network'] {
		text-fill: @route_label_rcn_colour;
	}
	
	[class_name='National trail'] {
		text-fill: @route_label_trail_colour;
	}
}
